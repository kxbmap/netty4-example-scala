...
object SecureChatKeyStore {
  ...
  def asInputStream: InputStream = new ByteArrayInputStream(Data.map(_.toByte))

  def certificatePassword: Array[Char] = "secret".toCharArray

  def keyStorePassword: Array[Char] = "secret".toCharArray
}
